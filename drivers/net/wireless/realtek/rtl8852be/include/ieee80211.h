...
#define is_supported_24g(band_type) ((band_type) & BAND_CAP_2G ? _TRUE : _FALSE)
#define is_supported_5g(band_type) ((band_type) & BAND_CAP_5G ? _TRUE : _FALSE)
#define is_supported_6g(band_type) ((band_type) & BAND_CAP_6G ? _TRUE : _FALSE)
#define is_supported_tx_cck(net_type) ((net_type) & (WLAN_MD_11B) ? _TRUE : _FALSE)
#define is_suuported_tx_ofdm(net_type) ((net_type) & (WLAN_MD_11G | WLAN_MD_11A) ? _TRUE : _FALSE)
#define is_supported_ht(net_type) ((net_type) & (WLAN_MD_11N) ? _TRUE : _FALSE)
#define is_supported_vht(net_type) ((net_type) & (WLAN_MD_11AC) ? _TRUE : _FALSE)
#define is_supported_he(net_type) ((net_type) & (WLAN_MD_11AX) ? _TRUE : _FALSE)
...
#define WLHDR_SIZE sizeof(struct rtw_ieee80211_hdr)
#endif
...
#endif
	RTW_WLAN_CATEGORY_HE = 30,
	RTW_WLAN_CATEGORY_PROTECTED_HE = 31,
